...
<?php
	...
	$resultStatus = $formData->getStatus();
	$resultGrade = $formData->getGrado();
	$resultShift = $formData->getTurno();
	$resultCivil = $formData->getMarital();
	...
	$resultChild = $profileInfo->queryChildSimple($id);
	$resultSchool = $profileInfo->querySchool($id);
	$resultTech = $profileInfo->queryTechSchool($id);
	$resultSibling = $profileInfo->querySiblings($id);
	$resultAcceptance = $profileInfo->queryAcceptance($id);
	$resultCentre = $profileInfo->queryCentre($id);
	$resultDetails = $profileInfo->queryDetails($id);
	$resultMother = $profileInfo->queryParent($id,'madre');
	$resultFather = $profileInfo->queryParent($id,'padre');
